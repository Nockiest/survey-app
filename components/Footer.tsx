...
export default function Footer() {
  return (
    <footer
      className="footer"
      {...stylex.props(FOOTER_STYLING.base, POSITIONING_STYLES.rowResponsive, SHADOWS.lg)}
    >
      ...
      >
        <li className="nav__item"  {...stylex.props(LIST.default)}>
          <h2 className="nav__title"  {...stylex.props(FOOTER_STYLING.h2 )}>Media</h2>
        ...
        <li className="nav__item nav__item--extra"  {...stylex.props(LIST.default)}>
          <h2 className="nav__title" {...stylex.props(FOOTER_STYLING.h2 )}>Technology</h2>
        ...
        <li className="nav__item"    {...stylex.props(LIST.default)}>
          <h2 className="nav__title" {...stylex.props(FOOTER_STYLING.h2 )}>Legal</h2>

          <ul className="nav__ul">
            <li>
            <Mylink href="mailto:ondralukes06@seznam.cz">Privacy Policy</Mylink>
            </li>
